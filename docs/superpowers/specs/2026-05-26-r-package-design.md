...
Matches Python byte-for-byte. Subject to change when [#98](https://github.com/posit-dev/shinyreact/issues/98) lands (nested children); R conforms to whichever format is current at PR time.
