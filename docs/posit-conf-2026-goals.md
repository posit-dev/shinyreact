...
- Other packages (not just `shinyreact`) to depend on the published `@posit-dev/shinyreact` npm package (naming decided in `decisions/2026-08-17-js-distribution.md`)
