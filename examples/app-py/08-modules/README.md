...
> **Note:** Uses `shinyreact`. The module/namespace machinery is implemented in the vendored `shiny-react` (via `ShinyModuleProvider` and `useShinyModuleNamespace`) and works in both the JSON-spec and `ui.tsx`-first models.
