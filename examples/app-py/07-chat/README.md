...
> **Note:** Uses `shinyreact`. The streaming pattern (server pushes message events, client appends them) ports directly to the `ui.tsx`-first model — `useShinyMessageHandler` works the same.
