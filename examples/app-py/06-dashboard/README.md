...
> **Note:** Uses `shinyreact`. See `DESIGN.md` §4 for why dashboards with many interconnected reactive paths are the natural sweet spot for Shiny on the server, regardless of whether the UI is rendered server-driven or `ui.tsx`-first.
