...
> **Note:** Uses `shinyreact`. The streaming pattern (server pushes message events, client appends them) ports directly to the SPA-first model — `useShinyMessageHandler` works the same.
