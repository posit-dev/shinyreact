...
The point: once you want a component library, you have to bring a build step. This example shows the canonical setup for SPA-first apps that want shadcn — Vite in lib-mode IIFE, with React externalized to `window.shinyreact`.
