# Example 16 — shadcn/ui + plotly.js (client-ui-first)

A `client-ui`-first Shiny app whose UI is a React app styled with [shadcn/ui](https://ui.shadcn.com/) components and Tailwind v4. Mirrors the layout from
