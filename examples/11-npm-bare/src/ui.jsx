import { useShinyInput, useShinyOutputStatus, useShinyOutputValue } from "@posit-dev/shinyreact";
import "@posit-dev/shinyreact/styles";
import { createRoot } from "react-dom/client";

import "./ui.css";

// The import above is the whole point of this example: the hooks are bundled
// into www/ui.js from `@posit-dev/shinyreact`, not read off
// `window.shinyreact` — the server puts no shinyreact JS on the page at all.
