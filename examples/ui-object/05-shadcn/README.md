...
> **Note:** Uses `shinyreact`. For the `client-ui`-first equivalent that uses *actual* shadcn components (real `cva`, real Tailwind v4, real `Card`/`Button`/etc.), see [example 16](../16-shadcn/).
