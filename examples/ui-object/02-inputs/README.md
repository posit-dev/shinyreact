...
> **Note:** Uses `shinyreact` (the JSON-spec package). For the `client-ui`-first equivalent of this kind of demo, write a React app that mounts shadcn or any other component library — see [example 16](../16-shadcn/).
