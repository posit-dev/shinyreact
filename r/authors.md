...
Schloerke B (2026). *shinyreact: Shiny UI Infrastructure for JSON-Driven
React Rendering*. R package version 0.0.0.9000,
<https://posit-dev.github.io/shinyreact/r>.

    @Manual{,
      title = {shinyreact: Shiny UI Infrastructure for JSON-Driven React Rendering},
