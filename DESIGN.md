...
5. **Define prototype acceptance criteria** — at minimum: an invisible build step via `shiny run`, a clear message type model, a bookmarking/init story, and explicit guidance for deployment and asset handling.
