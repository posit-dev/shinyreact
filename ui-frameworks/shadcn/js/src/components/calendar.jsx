...
// shared @/lib/button-base primitive instead of @/registry/new-york-v4/ui/button.
...
// --- shinyreact bridge ---
// A single-date picker. The selected date crosses the wire as an ISO string
// "YYYY-MM-DD" — a plain string input, NOT the shiny.datetime handler. Date
// objects are not JSON-serializable and the shiny.datetime input-handler must
// be registered server-side; an ISO string is robust and parses cleanly with
// date.fromisoformat() (Python) or as.Date() (R).
//
// Props:
//   input_id (str)          — Shiny input id; value is an ISO date string or null.
//   selected (str, optional)— initial ISO date "YYYY-MM-DD".
...
export { ShinyCalendar as Calendar };
