...
// --- shinyreact bridge ---
// Display-only data table driven by `columns` + `rows` props.
// Props:
//   columns (str[])    — header labels.
//   rows (cell[][])    — each row is an array of cell values (string/number).
//   caption (str, opt) — caption shown below the table.
// No Shiny input — this renders server-computed data. For a fully reactive
