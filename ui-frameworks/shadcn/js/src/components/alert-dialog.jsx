...
function AlertDialogAction({
  ...
  return <Button variant={variant} size={size} asChild><AlertDialogPrimitive.Action
...
function AlertDialogCancel({
  ...
  return <Button variant={variant} size={size} asChild><AlertDialogPrimitive.Cancel
