...
// Note: shadcn ships this with class-variance-authority. This project inlines
// variants as a plain object instead (no cva dependency).
  ...
  return (
    <TabsPrimitive.List
      ...
      className={cn(
        ...
        tabsListVariants[variant] ?? tabsListVariants.default,
        className
      )}
      {...props}
    />
